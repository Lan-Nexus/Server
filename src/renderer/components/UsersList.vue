<template>
  <div>
    ...
    <div class="bg-base-100/50 backdrop-blur-sm border border-base-300/20 rounded-2xl p-6 shadow-lg">
      <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        <!-- Stats -->
        <div class="flex items-center gap-6">
          <div class="stat p-0">
            <div class="stat-title text-sm">Total Users</div>
            <div class="stat-value text-2xl text-primary">{{ usersStore.totalUsers }}</div>
          </div>
          <div class="divider divider-horizontal"></div>
          <div class="stat p-0">
            <div class="stat-title text-sm">Filtered Results</div>
            <div class="stat-value text-2xl text-secondary">{{ filteredUsers.length }}</div>
          </div>
        </div>
    ...
    <div v-else-if="usersStore.users.length === 0" class="text-center py-12">
      <div class="max-w-md mx-auto">
        <div class="p-4 bg-base-200/50 rounded-full w-24 h-24 mx-auto mb-4 flex items-center justify-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    <div v-else-if="filteredUsers.length === 0" class="text-center py-8">
      <div class="max-w-md mx-auto">
        <div class="p-3 bg-warning/10 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="card-body">
          ...
          <div class="flex items-start justify-between mb-4">
            ...
            <div class="dropdown dropdown-end">
              ...
              <ul tabindex="0" class="dropdown-content menu bg-base-100 border border-base-300/20 rounded-box z-[1] w-44 p-2 shadow-xl">
                <li>
                  <button
    ...
    <div class="modal" role="dialog">
      <div class="modal-box bg-base-100/95 backdrop-blur-sm border border-base-300/20">
